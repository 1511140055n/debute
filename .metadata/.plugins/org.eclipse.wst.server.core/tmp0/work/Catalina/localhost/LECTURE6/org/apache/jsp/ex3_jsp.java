 ...
 * Generated at: 2017-05-23 04:46:01 UTC
...
try {
	if("登録".equals(btn)){
      ...
      out.write("\t\t");
      if (true) {
        _jspx_page_context.forward("error1.jsp" + (("error1.jsp").indexOf('?')>0? '&': '?') + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("btn", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode(String.valueOf( btn ), request.getCharacterEncoding()));
        return;
      }
      out.write('\r');
      out.write('\n');
